    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="mt-2 text-sm text-gray-600">
          We have sent an OTP message with the verification code to <span className="font-medium">+234XXXXXXXX</span>
        </p>
      </div>
      ...
      <Button type="submit" className="w-full bg-[#2E5DFC]" disabled={!isComplete}>
        Continue
      </Button>
    </div>
  )
